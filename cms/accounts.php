               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
						...
						<div class="col-md-4">
					 <p class="text-center">
                      <a href="memberbin.php" class="btn btn-danger btn-round green"> Removed Members  <span style="margin-left:10px;" class="glyphicon glyphicon-trash"></span></a>
                    </p>
					 </div>
			  ...
			  <div style="float:left; margin-top:10px; margin-right:10px; padding-left: 20px;" id="DontPrint">
                ...
                <div class="col-md-12">
				  ...
				  $date = date("Y/m/d"); //here my date format in my DB is 2010/09/30
					                   ...
					                   $tablequery="SELECT * FROM accounts";
										...
										while($tablerows=mysqli_fetch_assoc($tableresult)) {
										 ...
										 $tablequery2="SELECT * FROM member WHERE memberid ='".$tablerows['memberid']."'";
										...
										$tablerows2=mysqli_fetch_assoc($tableresult2)
										  ?>  
						<tr>
						<td><a href="member_detail.php?memberid=<?php echo $tablerows['memberid']; ?>&&member_detail=<?php echo $tablerows2['lastname'].'_'.$tablerows2['firstname']; ?>"><img src="form/img/img_member/<?php echo $tablerows2['picture']; ?>" style="width:40px; height:40px; border-radius:50%;"/></a></td>
                          <td><a href="member_detail.php?memberid=<?php echo $tablerows['memberid']; ?>&&member_detail=<?php echo $tablerows2['lastname'].'_'.$tablerows2['firstname']; ?>"><?php echo $tablerows2['lastname']." ".$tablerows2['firstname']; ?></a></td>
                          <td><b><?php echo $tablerows['username']; ?></b></td>
                          <td><b><?php echo $tablerows['realpass'];  ?></b></td>
                          <td><div>
						  
						  <form method="post" action="emailaccount.php">
						  <input type="hidden" name="salutation" value="<?php echo $tablerows2['salutation']; ?>" >
						  <input type="hidden" name="firstname" value="<?php echo $tablerows2['firstname']; ?>" >
						  <input type="hidden" name="lastname" value="<?php echo $tablerows2['lastname']; ?>" >
						  <input type="hidden" name="email" value="<?php echo $tablerows2['email']; ?>" >
						  <input type="hidden" name="username" value="<?php echo $tablerows['username']; ?>" >
						  <input type="hidden" name="realpass" value="<?php echo $tablerows['realpass']; ?>" >
						   <input type="submit" class="btn btn-default" name="send" value="Email Detail">
						  </form>
