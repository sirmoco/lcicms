          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
						 ...
						 <div class="col-md-6">
							  ...
							  if($tablerowsacc['ministry_head']==0){
								 ...
								 <input type="checkbox" class="checkbox" value="1"  id="validate_agree" name="ministry_head"/>
                                  ...
                                  <label style="color:#0f95fc;">MINISTRY HEAD</label> 
							 <?php 
							 }
							 ?>
					 ...
					 <div class="col-md-6">
						 ...
						 <div class="col-md-6">
							  ...
							  if($tablerowsacc['ministry_head']==0){
								  ...
								  ?>
								  <input type="checkbox" class="checkbox" value="1"  id="validate_agree" name="ministry_head" checked disabled>
			  ...
			  <div class="row" style=" margin-top:10px; margin-right:10px; padding-left: 20px; border:2px solid #FECE1A;" id="DontPrint">
			   ...
			   <?php
							  if($tablerowsacc['account_type']!=1 && $tablerowsacc['memberid'] != $_SESSION['memberid']){
								  ?>
								<h1>No roles have been assigned to <span><?php echo $tablerowsmem['firstname'].' '.$tablerowsmem['lastname']; ?></span> at the moment.</h1>  
								  
								  <?php
							  }elseif($tablerowsacc['account_type']!=1 && $tablerowsacc['memberid'] = $_SESSION['memberid']){
?>
<h1>No roles have been assigned to you at the moment.</h1>  
<?php
	   ...
	   -moz-box-shadow: 0 8px 6px -6px black;
	        box-shadow: 0 8px 6px -6px black; max-width:150px; max-height:150px; margin:5px; ">
					  ...
					  <div class="panel-heading" style="background:#fff;"><h6 style="color:#0f95fc; ">Assign Sheep</h6></div>
					  </div></a>
	   ...
	   -moz-box-shadow: 0 8px 6px -6px black;
	        box-shadow: 0 8px 6px -6px black;
					 border:4px solid #0f95fc; max-width:150px; max-height:150px; margin:5px; ">
					  <img src="asset/img/About.png" style=" width:100%; height:100%; "/>
					  <div class="panel-heading" style="background:#fff;"><h6 style="color:#0f95fc; ">Sheep</h6></div>
					  </div></a>
					  <a href="" class="link"> <div class="responsive-table col-md-4" style="background:#0f95fc; border-radius:5px;
					 -webkit-box-shadow: 0 8px 6px -6px black;
	   -moz-box-shadow: 0 8px 6px -6px black;
