                    ...
                    <div class="panel-body">
					 ...
					 $querydate='SELECT service_attendance.date FROM service_attendance ORDER BY attid DESC LIMIT 1';
										...
										$tablerows=mysqli_fetch_assoc($tableresult);
										  ...
										  ?>  
						<tr>
						<td><a href="member_detail.php?memberid=<?php echo $tablerows['memberid']; ?>&&member_detail=<?php echo $tablerows['lastname'].'_'.$tablerows['firstname']; ?>"><img src="<?php echo $tablerows['picture']; ?>" style="width:40px; height:40px; border-radius:50%;"/></a></td>
