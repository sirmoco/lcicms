                  ...
                  <div class="panel-body">
                    <div class="col-md-4">
                        ...
                        <p class="animated fadeInDown">
						 ...
						 <div class="col-md-2">
						<p class="text-center">
                      <a href="present.php" class="btn btn-success btn-round green"> Members Present  <span style="margin-left:10px;" class="glyphicon glyphicon-send"></span></a>
                    </p>
					</div>
					 <div class="col-md-2">
					<p class="text-center">
                      <a href="not_present.php" class="btn btn-success btn-round green"> Members Absent  <span style="margin-left:10px;" class="glyphicon glyphicon-send"></span></a>
                    </p>
                    </div>
					 <div class="col-md-4">
					 <p class="text-center">
                  ...
                  <div class="panel">
					...
					// }
									if(date("w",$timestamp)==0){
										...
										$tablequery='SELECT * FROM member WHERE memberid NOT IN(SELECT service_attendance.memberid FROM service_attendance WHERE service_attendance.date=CURRENT_DATE())';
										$tableresult = mysqli_query($process->connectDB(),$tablequery);
		                                $tablerows=$process->queryrow($tablequery);  
		                                if($tablerows>0){
										...
										while($tablerows=mysqli_fetch_assoc($tableresult)) {
										  ...
										  ?>  
						<tr>
						<td><img src="<?php echo $tablerows['picture']; ?>" style="width:40px; height:40px; border-radius:50%;"/></td>
                          <td><?php echo $tablerows['lastname']." ".$tablerows['firstname']; ?></td>
                          <td><?php echo $tablerows['mobile1']; ?></td>
                          <td><div><form method="post"  id="attendForm"><div id="message"></div> <input type="hidden" name="memberid" value="<?php echo $tablerows['memberid']; ?>">
						  <input type="hidden" name="accountid" value="<?php echo $_SESSION['accountid']; ?>">
						  <input type="submit" name="submit" class="btn btn-primary" value="Present"/></form><i  id="check" style="display:none;" class="fa fa-check-square-o"></i></div></td>
                        </tr>
						 <?php  }
											
											} 
									}else{
						 echo "Attendance is checked only on Sundays";
					 }
											?>
                      </tbody>
                        </table>
