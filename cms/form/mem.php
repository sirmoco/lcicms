          ...
          <div id="content">
            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form id="example1" class="cmxform" action="../include/domem.php" method="post">
                            <h3>Personal</h3>
                            <fieldset>
                                <legend>Member Information</legend>
								<div class="row" style="margin-right: -1px;
margin-left: -1px; margin-top:0px;">
								<div class="form-group col-md-3" style="margin-top:40px !important;">
								<label>Title</label>
                          <select name="title" class="select2-A"  >
						   <option></option>
                         ...
                         <div class="form-group form-animate-text col-md-3" style="margin-top:40px !important;">
                          <input type="text" name="fname" class="form-text"  >
                          <span class="bar"></span>
                          <label>First Name</label>
                        </div>
						<div class="form-group form-animate-text col-md-3" style="margin-top:40px !important;">
                          <input type="text" name="lname" class="form-text"  >
                          <span class="bar"></span>
                          <label>Last Name</label>
                        </div>
						<div class="form-group form-animate-text col-md-3" style="margin-top:40px !important;">
                          <input type="text" name="oname" class="form-text"  >
                          <span class="bar"></span>
...
margin-left: -1px; margin-top:0px;">
								<div class="form-group col-md-3" style="margin-top:40px !important;">
								<label>Gender</label>
                          <select name="gender" class="select2-A"  >
                          <option></option>
                         ...
                         <div class="form-group form-animate-text col-md-3" style="margin-top:30px !important;">
                          <input type="text" name="dob" class="form-text"  >
                          <span class="bar"></span>
                          <label>Date of Birth</label>
                        </div>
						
						</div>
							<center><form action="../include/addaboutimage.php" enctype="multipart/form-data" method="post">
		    <span class="btn btn-default btn-file">
       
<input id="file" name="file" type="file"/>
</span>
<input id="Submit" name="submit" type="submit" class="btn btn-success" value="Change Image" />
</form></center>
                            </fieldset>
