        ...
        <!-- start: Content -->
          <div id="content">
                ...
                <div class="panel">
                      ...
                      <div class="col-md-12" style=" padding-top:30px;">
                        ...
                        <div class="col-md-9">
						  ...
						  <div class="form-group form-animate-text col-md-3" >
                               <select class="select2-A" name="salutation" style=" color:#337ab7;" >
						   ...
						   <div class="form-group form-animate-text col-md-4" >
                              <input type="text" class="form-text"  id="validate_firstname" pattern="[A-Za-z]+" style=" color:#337ab7;" name="firstname" required>
                              <span class="bar"></span>
                              <label>Firstname</label>
                            </div>

                            <div class="form-group form-animate-text col-md-5" >
                              <input type="text" class="form-text" id="validate_lastname" pattern="[A-Za-z]+" style=" color:#337ab7;" name="lastname" required>
                              <span class="bar"></span>
				  ...
				  $date = date("Y/m/d");
							?>
							 ...
							 <input class="form-text" name="dob" type="date" style=" color:#337ab7;"  min="1900/01/01" max="<?php echo $date; ?>" >
                      ...
                      <div class="form-group form-animate-checkbox">
					   ...
					   <div class="col-md-6 panel" style="padding:20px;padding-bottom:0px; ">
							  ...
							  <div class="form-group form-animate-checkbox">
                                  <input type="radio" class="checkbox" value="Female" style=" color:#337ab7;" id="validate_agree" name="gender" required>
                                  Female
                              </div>
                      </div>
						  ...
						  <div class="row" >
							<div class="form-group form-animate-text col-md-3" >
                               <select class="select2-A" name="maritalstatus" style=" color:#337ab7;" >
			...
			<option value="Other">Other</option>
                           ...
                           <option value="Ghana">Nationality | Ghana</option>
						  ...
						  <div class="form-group form-animate-text col-md-4" style="margin-top:0px !important;">
                              <input type="text" class="form-text" id="" pattern="^\d{4}-\d{3}-\d{4}$" style=" color:#337ab7;" name="mobile1" >
                              <span class="bar"></span>
                              <label>Mobile</label>
                            </div>
							<div class="form-group form-animate-text col-md-4" style="margin-top:0px !important;">
                              <input type="tel" class="form-text"  pattern="^\d{4}\d{3}\d{4}$" style=" color:#337ab7;" name="mobile2" >
                              <span class="bar"></span>
                              <label>Mobile 2</label>
                            </div>
                            
							 <div class="form-group form-animate-text col-md-4" style="margin-top:0px !important;">
                              <input type="email" class="form-text" id="validate_email" style=" color:#337ab7;" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" name="email">
                              <span class="bar"></span>
                              <label>Email</label>
                            </div>
							</div>
							...
							<div class="row" >
							<div class="form-group form-animate-text col-md-4" style="margin-top:0px !important;">
                              <input type="text" class="form-text"  style=" color:#337ab7;" name="residence" >
                              <span class="bar"></span>
                              <label>Residence</label>
                            </div>
							<div class="form-group form-animate-text col-md-4" style="margin-top:0px !important;">
                              <input type="text" class="form-text"   style=" color:#337ab7;" name="post_address" >
                              <span class="bar"></span>
							...
							<div class="form-group form-animate-text col-md-8" style="margin-top:0px !important;">
                              <textarea class="form-text" name="directiontohse" style=" color:#337ab7;" ></textarea>
                              <span class="bar"></span>
							...
							<div class="form-group form-animate-text col-md-4" >
							  ...
							  <?php
										...
										while($branchrows=mysqli_fetch_assoc($branchresult)) {
										  ...
										  ?> 
                   <option value="<?php echo $branchrows['branch_id']; ?>"><?php echo $branchrows['branch_name'].' <i>'.$branchrows['branch_location'].'</i>'; ?></option>
                   ...
                   <option value="<?php echo $tablerows['memberid']; ?>"><?php echo $tablerows['firstname'].' '.$tablerows['lastname'] ; ?></option>
						   ...
						   <option value="Sibling">Sibling</option>
							...
							<div class="form-group form-animate-text col-md-6" style="margin-top:0px !important;">
                              <input type="text" class="form-text" id="cp_mobile" pattern="^\d{4}\d{3}\d{3}$" style=" color:#337ab7;" name="cp_mobile" >
                              <span class="bar"></span>
                            ...
                            <center>  <input class="submit btn btn-danger" type="submit" value="Submit" name="submit">
             ...
             <div class="blog_post_descr ">		
                                                ...
                                                <div class="col-md-9" style="border:1px solid #0f95fc; padding-top:5px; border-radius:10px;"> 
												
												 <input type="file"  id="file-simple" data-preview-file-type="any" title="Browse file" class="file  btn-file"    name="files" value="" />
