                  ...
                  <div class="panel">
					...
					// }
									if(date("w",$timestamp)==0){
										...
										$tablequery1='SELECT * FROM assignment WHERE shepherd="'.$_SESSION['memberid'].'" && sheep NOT IN(SELECT service_attendance.memberid FROM service_attendance WHERE service_attendance.date=CURRENT_DATE())';
