                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
					 ...
					 $querydate='SELECT service_attendance.date FROM service_attendance ORDER BY attid DESC LIMIT 1';
										...
										$tablequery1='SELECT * FROM assignment WHERE shepherd="'.$tablerowshead['memberid'].'" && sheep IN(SELECT service_attendance.memberid FROM service_attendance WHERE service_attendance.date >= "'.($rowsdate['date']-1).'")';
