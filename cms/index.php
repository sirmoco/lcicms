...
<?php
      ...
      ?>  </h3>            
    <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span> Apache, Navrongo</p>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="col-md-6 col-sm-6 text-right" style="padding-left:10px;">
                          <h3 style="color:#DDDDDE;"><span class="fa  fa-map-marker"></span> Navrongo</h3>
                ...
                <div class="col-md-12">
				 ...
				 <form method="post" id="post" >
                    <div class="panel-heading padding-0 bg-white border-none">
                        <textarea placeholder="Share your thoughts?" id="comm" name="timelinepost" style="height:60px;"></textarea>
						<input type="hidden" name="memberid" value="<?php echo $tablerowshead['memberid']; ?>">
                    ...
                    <div class="panel-body">
                      <div class="col-md-12 padding-0">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 padding-0">
                          <button type="submit" class="btn btn-round pull-right" name="submit">
                            <span>SEND</span>
                              ...
                              <div class="panel box-v2">
                                  <div class="panel-heading padding-0">
                                    ...
                                    <div class="box-v2-detail">
                                      <img src="form/img/img_member/<?php echo $tablerowshead['picture']; ?>" class="img-responsive"/>
                                      <h4><?php echo $tablerowshead['firstname'].' '.$tablerowshead['lastname']; ?></h4>
                                    </div>
                                  </div>
                                  <div class="panel-body">
                                    <div class="col-md-12 padding-0 text-center">
                                      <div class="col-md-4 col-sm-4 col-xs-6 padding-0">
                                          <h3><?php echo $ministrynum; ?></h3>
                                          <p>Ministries</p>
                                      </div>
                                      <div class="col-md-4 col-sm-4 col-xs-6 padding-0">
                                          <h3><?php echo $sheepnum; ?></h3>
                                          <p>Sheeps</p>
                                      </div>
              ...
              <div class="panel-heading"><h3>Notifications</h3></div>
                <div class="panel-body">  
				 <?php
				  ...
				  $today =date("r",time());
				  $date = date("m-d"); //here my date format in my DB is 2010/09/30
					 $date2 = date("y-m-d"); 
					
										$tablequery="SELECT * FROM member WHERE bday ='".$date."'";
										$tableresult = mysqli_query($process->connectDB(),$tablequery);
		                                $tablerows=$process->queryrow($tablequery);  
		                                if($tablerows>0){
                    ...
                    <div class="col-md-10 iconic-timeline-detail">
                      <span class="pull-right"><?php echo $today; ?></span>
                      <h5 style="color:#E30049;">Birthday!
                      </h5>
                      <p> Today is <b><font style="color:#337ab7;"><?php echo $tablerows['firstname']." ".$tablerows['lastname']."'s"; ?></font></b> Birthday,Remember to send a wish.</p>
                    </div>
                  </div>
				  <?php
										}}else{
				  ...
				  ?>
                  <?php
					 $querydate='SELECT service_attendance.date FROM service_attendance ORDER BY attid DESC LIMIT 1';
										$dateresult = mysqli_query($process->connectDB(),$querydate);
		                                $rowsdate=$process->queryrow($querydate);  
		                                
											
										$rowsdate=mysqli_fetch_assoc($dateresult);
											
										$timestamp = date("y-m-d");
										$tablequery1='SELECT * FROM assignment WHERE shepherd="'.$tablerowshead['memberid'].'" && sheep NOT IN(SELECT service_attendance.memberid FROM service_attendance WHERE service_attendance.date >= "'.($rowsdate['date']-1).'")';
										$tableresult1 = mysqli_query($process->connectDB(),$tablequery1);
		                                $tablerows1=$process->queryrow($tablequery1);  
		                                $absentnum=mysqli_num_rows($tableresult1);
											
										$tablerows1=mysqli_fetch_assoc($tableresult1);
										if($absentnum > 0){
										?>
										<div class="col-md-12 iconic-timeline">
                        <div class="col-md-2 iconic-timeline-icon">
                        ...
                        <div class="col-md-10 iconic-timeline-detail">
                          ...
                          <a href="form/absent_this_week.php" style="color:#000;"><p> <span style="background:red;  border:2px solid; padding:2px 2px 2px 2px; color:#fff; border-radius:50%;"><?php echo $absentnum;?></span> of your sheeps where absent this sunday.</p>
                       </a> </div>
                      </div>
					  <?php
										}
					  ?>
                            ...
                            <div class="col-md-12 padding-0">
                              <div class="panel bg-light-blue">
								...
								<span>Scripture for the week | <b>Matth 6:36</b></span>
                                   <p class="animated fadeInUp quote">
								   Seek first ..."</p>
                                    <div class="col-md-12 padding-0">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$(document).on('submit','#post',function(e) {
			  ...
			  success: function(response){
					 ...
					 $('#posted').text(response);
					 $('#comm').val('');
					 $('#timelinedata').load('timeline.php');
	 ...
	 <script>
	 $('#timelinedata').load('timeline.php').fadeInUp('slow');
