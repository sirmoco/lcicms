          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Add Inventory</h3>
					
					<div class="form-group form-animate-text col-md-2" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="validate_confirm_password" name="occupation" >
                              <span class="bar"></span>
