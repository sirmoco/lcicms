            ...
            <div id="content">
			  ...
			  <div class="row">
				<div class="col-md-3">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      <div class="responsive-table" style="border:4px solid #0f95fc; min-height:200px; min-width:200px;
						max-width:200px;
					  border-radius:50%;">
					  <img src="<?php echo $tablerowsmem['picture']; ?>" style=" min-height:192px; min-width:192px;
						max-width:192px;
					  border-radius:50%;"/>
                  ...
                  <div class="panel">
                    <div class="panel-heading" style="background:#fff;"><h6 style="color:green; ">Change Account Password</h6></div>
                    <div class="panel-body">
                      <div class="responsive-table">
					  
					  <form class="cmxform" method="post" action="change_pass.php"  >
					 ...
					 <div class="row">
                              ...
                              <input type="password" class="form-text" id="password"  style=" color:#337ab7;" placeholder="New Password" name="password" required>
                              <span class="bar"></span>
						 ...
						 <div class="row">
						 <div class="form-group form-animate-text col-md-6" style="margin-top:0px !important;">
                              <input type="password" class="form-text" id="confirm_password" style=" color:#337ab7;" placeholder="Confirm Password" name="confirm_password" required>
                              <span class="bar"></span>
                              <label>Confirm Password</label>
                            </div>
							 </div>
							 <input type="hidden"  value="<?php echo $_SESSION['accountid']; ?>"   name="accountid" >
                              <input class="submit btn btn-success" type="submit" value="Change Password" name="pass"/>
						</form>
