               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
						...
						<p class="text-center">
                      <a href="form/attendance.php" class="btn btn-success btn-round green"> Start Checking Attendance  <span style="margin-left:10px;" class="glyphicon glyphicon-send"></span></a>
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
					 ...
					 <?php
										...
										$tablequery="SELECT * FROM member WHERE memberid=0";
										$tableresult = mysqli_query($process->connectDB(),$tablequery);
		                                $tablerows=$process->queryrow($tablequery);  
		                                if($tablerows>0){
										...
										while($tablerows=mysqli_fetch_assoc($tableresult)) {
										  ...
										  ?>  
						<tr>
						<td><img src="form/img/img_member/<?php echo $tablerows['picture']; ?>" style="width:70px; height:70px; border-radius:50%;"/></td>
                          <td><?php echo $tablerows['lastname']." ".$tablerows['firstname']; ?></td>
                          <td><?php echo $tablerows['mobile1']; ?></td>
                          <td><?php echo $tablerows['area']; ?></td>
                          <td><?php echo $tablerows['email']; ?></td>
                          <td><?php echo $tablerows['cp']; ?></td>
                          <td><div><a href="form/memberregistrationform2.php?memberid=<?php echo $tablerows['memberid']; ?>" class="btn btn-primary"> Edit</a><a class="btn btn-danger"> Del <span class="fa fa-trash"></span></a></div></td>
                        </tr>
						 <?php  }
