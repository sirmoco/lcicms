          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
						...
						<div class="col-md-4">
					 <p class="text-center">
                      <a href="members.php" class="btn btn-success btn-round green"> Members  <span style="margin-left:10px;" class="glyphicon glyphicon-profile"></span></a>
                    </p>
					 </div>
                    </div>
                  </div>
			  ...
			  <div style="float:left; margin-top:10px; margin-right:10px; padding-left: 20px;" id="DontPrint">
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Removed Member list</h3></div>
                    <div class="panel-body">
				  ...
				  $date = date("Y/m/d"); //here my date format in my DB is 2010/09/30
										...
										$tablequery="SELECT * FROM member_bin";
										$tableresult = mysqli_query($process->connectDB(),$tablequery);
		                                $tablerows=$process->queryrow($tablequery);  
		                                if($tablerows>0){
						...
						<td><a href="member_detail.php?memberid=<?php echo $tablerows['memberid']; ?>&&member_detail=<?php echo $tablerows['lastname'].'_'.$tablerows['firstname']; ?>"><img src="form/img/img_member/<?php echo $tablerows['picture']; ?>" style="width:40px; height:40px; border-radius:50%;"/></a></td>
						  ...
						  <input type="submit" class="btn btn-danger" name="delete" value="Restore">
						  </form>
						  <?php
							}else{
								?>
