				   ...
				   ?>
					...
					?>
					 <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-table"></span> Attendance <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
					  <li><a href="form/myattendance.php">Member Attendance</a></li>
                        <li><a href="form/my_notpresent.php">Missed Members</a></li>
                        <li><a href="form/my_visitations.php">Visitation</a></li>
                      </ul>
                    </li>
