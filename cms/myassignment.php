      ...
      <div class="container-fluid LCICMS-wrapper">
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Member Roles</h3>
                        <p class="animated fadeInDown">
                          Accounts <span class="fa-angle-right fa"></span> Roles
                        </p>
                    </div>
                  </div>
              </div>
              ...
              <div class="top-20 padding-0">
			   <?php
										...
										$tablequeryacc="SELECT * FROM accounts WHERE accountid='".$_SESSION['accountid']."' && memberid='".$tablerowshead['memberid']."'";
			  ...
			  <div class="row">
				<div class="col-md-3">
                  ...
                  <div class="panel">
                    <div class="panel-heading" style="background:#fff;"><h6 style="color:green; ">Member Roles</h6></div>
                    <div class="panel-body">
					  ...
					  <div class="col-md-6">
							  ...
							  if($tablerowsacc['shepherd']==0){
								  ...
								  ?>
								  <input type="checkbox" class="checkbox" value="1"  id="validate_agree" name="shepherd" checked disabled>
                                  <label style="color:#0f95fc; font-size:12px;">SHEPHERD</label> 
							 <?php 
							 }
							 ?>
						 ...
						 <div class="col-md-6">
							  ...
							  if($tablerowsacc['information']==0){
								  ...
								  ?>
								  <input type="checkbox" class="checkbox" value="1"  id="validate_agree" name="information" checked disabled>
						 ...
						 <div class="col-md-6">
							  ...
							  if($tablerowsacc['follow_up']==0){
								  ...
								  ?>
								  <input type="checkbox" class="checkbox" value="1"  id="validate_agree" name="follow_up" checked disabled>
						 ...
						 <div class="col-md-6">
							  ...
							  if($tablerowsacc['data_entry']==0){
								  ...
								  ?>
								  <input type="checkbox" class="checkbox" value="1"  id="validate_agree" name="data_entry" checked disabled>
						 ...
						 <div class="col-md-6">
                              <div class="form-group form-animate-checkbox">
                                 							   <?php
							  if($tablerowsacc['aofm_leader']==0){
								  ?>
								 
								  <?php
							  }else{
								  ?>
								  <input type="checkbox" class="checkbox" value="1"  id="validate_agree" name="aofm_leader" checked  disabled>
						 ...
						 <div class="col-md-6">
							  ...
							  if($tablerowsacc['account']==0){
								  ...
								  ?>
								  <input type="checkbox" class="checkbox" value="1"  id="validate_agree" name="account" checked disabled>
	   ...
	   -moz-box-shadow: 0 8px 6px -6px black;
	        box-shadow: 0 8px 6px -6px black;
					 border:4px solid #0f95fc; max-width:150px; max-height:150px; margin:5px; ">
					  <img src="asset/img/About.png" style=" width:100%; height:100%; "/>
					  <div class="panel-heading" style="background:#fff;"><h6 style="color:#0f95fc; ">Attendance</h6></div>
					  </div></a>
					  <a href="" class="link"> <div class="responsive-table col-md-4" style="background:#0f95fc; border-radius:5px;
					 -webkit-box-shadow: 0 8px 6px -6px black;
	   -moz-box-shadow: 0 8px 6px -6px black;
	        box-shadow: 0 8px 6px -6px black;
					 border:4px solid #0f95fc; max-width:150px; max-height:150px; margin:5px; ">
					  <img src="asset/img/About.png" style=" width:100%; height:100%; "/>
					  <div class="panel-heading" style="background:#fff;"><h6 style="color:#0f95fc; ">Visit</h6></div>
					  </div></a>
					  </div>
					  </div>
					  </div>
