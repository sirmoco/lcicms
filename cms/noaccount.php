...
<head>
 ...
 <body id="LCICMS" class="dashboard">
  <?php
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              <div class="opener-left-menu is-open">
                ...
                <a href="noaccount.php" class="navbar-brand"> 
                 <b>LCICMS</b>
                </a>
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span><?php echo $tablerowshead['firstname'].' '.$tablerowshead['lastname']; ?></span></li>
                  <li class="dropdown avatar-dropdown">
                   <img src="<?php echo $tablerowshead['picture']; ?>" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Sunday Service</h3>
                ...
                <div class="col-md-12" style="padding:20px;">
                    <div class="col-md-12 padding-0">
                        <div class="col-md-8 padding-0">
                            <div class="col-md-12 padding-0">
                               <h2> YOU HAVE NOT BEEN GIVEN PRIVELAGES, CONTACT YOUR SHEPHERD</h2>
                            </div>
                            <div class="col-md-12">
                ...
                <div class="col-md-12">
				 ...
				 <form method="post" id="post" >
                    <div class="panel-heading padding-0 bg-white border-none">
                        <textarea placeholder="what do you think?" name="timelinepost"></textarea>
                 ...
                 <div id="timelinedata">
                        ...
                        <div class="col-md-4">
                              ...
                              <div class="panel box-v2">
                                  <div class="panel-heading padding-0">
                                    ...
                                    <div class="box-v2-detail">
                                      <img src="<?php echo $tablerowshead['picture']; ?>" class="img-responsive"/>
                            ...
                            <div class="col-md-12 padding-0">
                             <div class="panel">
              <div class="panel-heading"><h3>Reminders</h3></div>
                <div class="panel-body">  
				 <?php
				  ...
				  $date = date("m-d"); //here my date format in my DB is 2010/09/30
                    ...
                    <div class="col-md-10 iconic-timeline-detail">
                      <span class="pull-right"><?php echo $date2; ?> --<?php echo $bday; ?>--<?php echo $date; ?></span>
      ...
      <!-- start: Mobile -->
      <div id="LCICMS-mobile" class="reverse">
        <div class="LCICMS-mobile-menu-list">
            <div class="col-md-12 sub-LCICMS-mobile-menu-list animated fadeInLeft">
                <ul class="nav nav-list">
                    <li class="active ripple">
      ...
      <button id="LCICMS-mobile-menu-opener" class="animated rubberBand btn btn-circle btn-danger">
