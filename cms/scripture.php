          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>Kpabitey Emmanuel</span></li>
          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-4">
					 ...
					 <div class="col-md-2">
						<p class="text-center">
                      <a href="not_present.php" class="btn btn-success btn-round green"> Missed Members  <span style="margin-left:10px;" class="glyphicon glyphicon-send"></span></a>
                    </p>
					</div>
					 <div class="col-md-2">
					<p class="text-center">
					 ...
					 <div class="col-md-4">
					 <p class="text-center">
                      <a href="attendance.php" class="btn btn-success btn-round green"> Check Attendance  <span style="margin-left:10px;" class="glyphicon glyphicon-send"></span></a>
                    </p>
					 </div>
                  </div>
              </div>
			  ...
			  <div style="float:left; margin-top:10px; margin-right:10px; padding-left: 20px;" id="DontPrint">
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Member list</h3></div>
                    <div class="panel-body">
					 ...
					 <?php
										...
										$tablequery='SELECT * FROM member WHERE memberid NOT IN(SELECT service_attendance.memberid FROM service_attendance WHERE service_attendance.date = CURRENT_DATE()) && memberid NOT IN(SELECT visitation.memberid FROM visitation WHERE visitation.date = CURRENT_DATE())';
						...
						<tr>
						<td></td>
                          <td><?php echo $tablerows['lastname']." ".$tablerows['firstname']; ?></td>
                          <td><?php echo $tablerows['mobile1']; ?></td>
						  <td><?php echo $tablerows['date']; ?></td>
                          <td><div><form method="post"  id="visit"><div id="message"></div> <input type="hidden" name="memberid" value="<?php echo $tablerows['memberid']; ?>">
						  <input type="hidden" name="accountid" value="<?php echo $_SESSION['accountid']; ?>">
						  <input type="submit" name="submit" class="btn btn-primary" value="Visit"/></form><i  id="check" style="display:none;" class="fa fa-check-square-o"></i></div></td>
                        </tr>
						 <?php  }
